            ...
            <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
                ...
                <li class="d-md-block d-none"> 
                    ...
                    <div class="input-group"><span class="input-icon">
                        <svg>
                            <use href="{{asset('admin/svg/icon-sprite.svg#search-header')}}"></use>
                        </svg>
                        ...
                        <div class="notitications-bar">
                            ...
                            <div class="tab-pane fade show active" id="pills-aboutus" role="tabpanel" aria-labelledby="pills-aboutus-tab">
                                ...
                                <div class="cart-dropdown notification-all">
                                    ...
                                    <li class="pr-0 pl-0 pb-3 pt-3">
                                        <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="{{asset('admin/images/other-images/receiver-img.jpg')}}" alt="">
                                ...
                                <ul> 
                                    <li>
                                    <div class="user-alerts"><img class="user-image rounded-circle img-fluid me-2" src="{{asset('admin/images/dashboard/user/5.jpg')}}" alt="user">
                                        <div class="user-name">
                                        <div> 
                                    ...
                                    <li>
                                    <div class="user-alerts"><img class="user-image rounded-circle img-fluid me-2" src="{{asset('admin/images/dashboard/user/6.jpg')}}" alt="user">
                                        <div class="user-name">
                                        <div> 
                            ...
                            <div class="tab-pane fade" id="pills-blog" role="tabpanel" aria-labelledby="pills-blog-tab">
                                ...
                                <ul> 
                                    ...
                                    <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                        <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{asset('admin/images/dashboard/user/3.jpg')}}" alt="user"></div>
                                    ...
                                    <li class="notification d-flex w-100 justify-content-between align-items-center">
                                    <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                        <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{asset('admin/images/dashboard/user/7.jpg')}}" alt="user"></div>
                                        <div class="flex-grow-1">
                                        <div class="common-space user-id w-100">
                                    ...
                                    <li class="notification d-flex w-100 justify-content-between align-items-center">
                                    <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                        <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{asset('admin/images/dashboard/user/5.jpg')}}" alt="user"></div>
                                        <div class="flex-grow-1">
                                        <div class="common-space user-id w-100">
                                    ...
                                    <li class="notification d-flex w-100 justify-content-between align-items-center">
                                    <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                        <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{asset('admin/images/dashboard/user/6.jpg')}}" alt="user"></div>
                                        <div class="flex-grow-1">
                                        <div class="common-space user-id w-100">
                            ...
                            <div class="tab-pane fade" id="pills-contactus" role="tabpanel" aria-labelledby="pills-contactus-tab">
                                ...
                                <ul>
                                    ...
                                    <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="{{asset('admin/images/other-images/cart-img.jpg')}}" alt="">
